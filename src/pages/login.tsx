...
import { Theme, withStyles, Grid, TextField, Button, Typography, CircularProgress } from '@material-ui/core';
...
export default withStyles((theme: Theme) => formsStyles(theme))(login);
